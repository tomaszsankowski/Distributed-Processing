// Whole template was made by professor Mariusz Matuszek. Our assignement was to only create static and dynamic
// libraries and make a program run with them using commands below. Not a lot of work from my side.
